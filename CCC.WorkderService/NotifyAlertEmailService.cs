...
using CCC.WorkderService.RefitClientFactory;
...
{
    public class NotifyAlertEmailService : IHostedService, IDisposable
    {
        public string FilePath { get; set; }
        private IOptions<NotifyAlertEmailServiceConfiguration> _options;
        public NotifyAlertEmailService(IOptions<NotifyAlertEmailServiceConfiguration> options)
        {
            _options = options;
        ...
        private async Task ScheduleServiceAsync()
        {
            try
            {
