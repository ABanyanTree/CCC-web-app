...
namespace CCC.UI.Controllers
{
	public class ReportController : Controller
	{
			...
			if (lst1 != null && lst1.Count > 0)
			{
				...
				if (lstTotalVet.Count > 0)
				{
					foreach (var vet in lstTotalVet)
					{
						...
						data.totalComplicationCount = lst1.Where(x => x.VetId == vet && x.ComplicationID!=null).ToList().Count;
						...
						data.complicationPercentage = Decimal.Round(Convert.ToDecimal(complication * 100), 2);
			...
			foreach (var cen in lstCenters)
			{
				...
				foreach (var mgr in lstCenterManagers)
				{
					...
					if (totalVetCount > 1)
					{
						...
						workSheet.Cells[rowCnt, colCnt, rowCnt + (totalVetCount - 1), colCnt].Merge = true;
					}
					...
					foreach (var vet in lstVets)
					{
						...
						var totalSurguriesResult = response.Where(x => x.CenterId == cen && x.CreatedBy == mgr
									&& x.VetId == vet && x.SurgeryDate != null).ToList();

						int totalSurguries = 0;
						if (totalSurguriesResult != null && totalSurguriesResult.Count > 0)
						{
							totalSurguries = totalSurguriesResult.Count;
						}
						...
						if (dogData != null)
						{
							dogSurgeries = dogData.Where(x => x.SurgeryDate != null).Count();
						}

						int catSurgeries = 0;
						if (catData != null)
						{
							catSurgeries = catData.Where(x => x.SurgeryDate != null).Count();
						}
						//dog
						...
						var d_complication = dogData.Where(x => x.Gender == CommonConstants.LOOKUPTYPE_PETGENDER_MALE && x.ComplicationID !=null).ToList();

						int d_complication_Male = 0;
						if (d_complication != null)
						{
							d_complication_Male = d_complication.Count;
						}

						int d_complication_FeMale = dogData.Where(x => x.Gender == CommonConstants.LOOKUPTYPE_PETGENDER_FEMALE &&  x.ComplicationID != null).ToList().Count;
						...
						int c_complication_Male = catData.Where(x => x.Gender == CommonConstants.LOOKUPTYPE_PETGENDER_MALE && x.ComplicationID != null).ToList().Count;

						int c_complication_FeMale = catData.Where(x => x.Gender == CommonConstants.LOOKUPTYPE_PETGENDER_FEMALE && x.ComplicationID != null).ToList().Count;
						...
						workSheet.Cells[rowCnt, colCnt + 3].Value = totalSurguries;

						workSheet.Cells[rowCnt, colCnt + 4].Value = d_complication_Male;
						workSheet.Cells[rowCnt, colCnt + 5].Value = d_complication_FeMale;

						workSheet.Cells[rowCnt, colCnt + 6].Value = d_sterilised_Male;
						workSheet.Cells[rowCnt, colCnt + 7].Value = d_sterilised_FeMale;

						workSheet.Cells[rowCnt, colCnt + 8].Value = d_Died_Male;
						workSheet.Cells[rowCnt, colCnt + 9].Value = d_Died_FeMale;

						workSheet.Cells[rowCnt, colCnt + 10].Value = d_OnHold_Male;
						workSheet.Cells[rowCnt, colCnt + 11].Value = d_OnHold_FeMale;
						...
						{
							decimal vetCross = Convert.ToDecimal(d_Complication_total) / Convert.ToDecimal(dogSurgeries);
							decimal d_ComplicationOfVet = Convert.ToDecimal(vetCross * 100);
							workSheet.Cells[rowCnt, colCnt + 12].Value = Decimal.Round(d_ComplicationOfVet, 2);
						}
						...
						if (totalvetCountByMgr == totalvetCountByCenter)
						{
							if (d_Sterilised_FinalTotal == 0)
							{
								if (d_Complication_total == 0)
								{
									workSheet.Cells[rowCnt, colCnt + 13].Value = "00.00";
								}
								else
								{
									workSheet.Cells[rowCnt, colCnt + 13].Value = "100.00";
								}
							...
							else
							{
								...
								workSheet.Cells[rowCnt, colCnt + 13].Value = Decimal.Round(d_ComplicationOfCenter, 2);
							}
						}
						else
						{
							workSheet.Cells[rowCnt, colCnt + 13].Value = "";
						}

						workSheet.Cells[rowCnt, colCnt + 14].Value = c_complication_Male;
						workSheet.Cells[rowCnt, colCnt + 15].Value = c_complication_FeMale;

						workSheet.Cells[rowCnt, colCnt + 16].Value = c_sterilised_Male;
						workSheet.Cells[rowCnt, colCnt + 17].Value = c_sterilised_FeMale;

						workSheet.Cells[rowCnt, colCnt + 18].Value = c_Died_Male;
						workSheet.Cells[rowCnt, colCnt + 19].Value = c_Died_FeMale;

						workSheet.Cells[rowCnt, colCnt + 20].Value = c_OnHold_Male;
						workSheet.Cells[rowCnt, colCnt + 21].Value = c_OnHold_FeMale;
						...
						{
							decimal c_vetCross = Convert.ToDecimal(c_Complication_total) / Convert.ToDecimal(catSurgeries);
							decimal c_ComplicationOfVet = Convert.ToDecimal(c_vetCross * 100);
							workSheet.Cells[rowCnt, colCnt + 22].Value = Decimal.Round(c_ComplicationOfVet);
						}
						...
						if (totalvetCountByMgr == totalvetCountByCenter)
						{
							if (c_Sterilised_FinalTotal == 0)
							{
								...
								{
									workSheet.Cells[rowCnt, colCnt + 23].Value = "00.00";
								}
								else
								{
									workSheet.Cells[rowCnt, colCnt + 23].Value = "100.00";
								}
							}
							else
							{
								...
								workSheet.Cells[rowCnt, colCnt + 23].Value = Decimal.Round(c_ComplicationOfCenter, 2);
							}

						}
						else
						{
							workSheet.Cells[rowCnt, colCnt + 23].Value = "";
						}

						var FirstTableRange = workSheet.Cells[rowCnt, colCnt, rowCnt, colCnt + 23];
						workSheet.Cells[rowCnt, colCnt, rowCnt, colCnt + 23].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
						workSheet.Cells[rowCnt, colCnt, rowCnt, colCnt + 23].Style.VerticalAlignment = ExcelVerticalAlignment.Center;
		...
		private void DesignVetReportTableHeader(ExcelWorksheet workSheet, int rowCnt, int colCnt)
		{
			...
			workSheet.Cells[rowCnt, colCnt, rowCnt + 2, colCnt + 23].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
			workSheet.Cells[rowCnt, colCnt, rowCnt + 2, colCnt + 23].Style.VerticalAlignment = ExcelVerticalAlignment.Center;
			workSheet.Cells[rowCnt, colCnt, rowCnt + 2, colCnt + 23].Style.Font.Bold = true;
			workSheet.Cells[rowCnt, colCnt, rowCnt + 2, colCnt + 23].Style.Fill.PatternType = ExcelFillStyle.Solid;
			workSheet.Cells[rowCnt, colCnt, rowCnt + 2, colCnt + 23].Style.Font.Color.SetColor(Color.FromArgb(255, 255, 255));


			var FirstTableRange = workSheet.Cells[rowCnt, colCnt, rowCnt + 2, colCnt + 23];
			FirstTableRange.Style.Border.Top.Style = ExcelBorderStyle.Thin;
			FirstTableRange.Style.Border.Left.Style = ExcelBorderStyle.Thin;
			FirstTableRange.Style.Border.Right.Style = ExcelBorderStyle.Thin;
			FirstTableRange.Style.Border.Bottom.Style = ExcelBorderStyle.Thin;
			...
			workSheet.Cells[rowCnt, colCnt + 3].Value = "Total Surgeries";
			workSheet.Cells[rowCnt, colCnt + 3, rowCnt + 2, colCnt + 3].Merge = true;
			workSheet.Cells[rowCnt, colCnt, rowCnt + 2, colCnt + 3].Style.Fill.BackgroundColor.SetColor(greenBGColor);

			workSheet.Cells[rowCnt, colCnt + 4].Value = "Dogs";
			workSheet.Cells[rowCnt, colCnt + 4, rowCnt, colCnt + 13].Merge = true;
			workSheet.Cells[rowCnt, colCnt + 4, rowCnt, colCnt + 13].Style.Fill.BackgroundColor.SetColor(greenBGColor);

			workSheet.Cells[rowCnt + 1, colCnt + 4].Value = "Complications";
			...
			workSheet.Cells[rowCnt + 2, colCnt + 4, rowCnt + 2, colCnt + 4].Style.Fill.BackgroundColor.SetColor(blueBGColor);

			workSheet.Cells[rowCnt + 1, colCnt + 6].Value = "Sterilised";
			...
			workSheet.Cells[rowCnt + 2, colCnt + 5, rowCnt + 2, colCnt + 7].Style.Fill.BackgroundColor.SetColor(blueBGColor);

			workSheet.Cells[rowCnt + 1, colCnt + 8].Value = "Expired";
			...
			workSheet.Cells[rowCnt + 1, colCnt + 10].Value = "OnHold";
			...
			workSheet.Cells[rowCnt + 1, colCnt + 12].Value = "% of Complication of Vet";
			...
			workSheet.Cells[rowCnt + 1, colCnt + 13].Value = "% of Complication of Center";
			workSheet.Cells[rowCnt + 1, colCnt + 13].Style.Fill.BackgroundColor.SetColor(voiletBGColor);

			workSheet.Cells[rowCnt + 2, colCnt + 13].Value = "";
			workSheet.Cells[rowCnt + 2, colCnt + 13].Style.Fill.BackgroundColor.SetColor(blueBGColor);

			workSheet.Cells[rowCnt, colCnt + 14].Value = "Cats";
			workSheet.Cells[rowCnt, colCnt + 14, rowCnt, colCnt + 23].Merge = true;
			workSheet.Cells[rowCnt, colCnt + 14, rowCnt, colCnt + 23].Style.Fill.BackgroundColor.SetColor(greenBGColor);

			workSheet.Cells[rowCnt + 1, colCnt + 14].Value = "Complications";
			...
			workSheet.Cells[rowCnt + 1, colCnt + 16].Value = "Sterilised";
			...
			workSheet.Cells[rowCnt + 1, colCnt + 18].Value = "Expired";
			...
			workSheet.Cells[rowCnt + 1, colCnt + 20].Value = "OnHold";
			workSheet.Cells[rowCnt + 1, colCnt + 20, rowCnt + 1, colCnt + 21].Merge = true;
			workSheet.Cells[rowCnt + 1, colCnt + 20, rowCnt + 1, colCnt + 21].Style.Fill.BackgroundColor.SetColor(voiletBGColor);

			workSheet.Cells[rowCnt + 2, colCnt + 20].Value = "Male";
			workSheet.Cells[rowCnt + 2, colCnt + 21].Value = "Female";
			workSheet.Cells[rowCnt + 2, colCnt + 20, rowCnt + 2, colCnt + 21].Style.Fill.BackgroundColor.SetColor(blueBGColor);

			workSheet.Cells[rowCnt + 1, colCnt + 22].Value = "% of Complication of Vet";
			workSheet.Cells[rowCnt + 1, colCnt + 22].Style.Fill.BackgroundColor.SetColor(voiletBGColor);

			workSheet.Cells[rowCnt + 1, colCnt + 23].Value = "% of Complication of Center";
			workSheet.Cells[rowCnt + 1, colCnt + 23].Style.Fill.PatternType = ExcelFillStyle.Solid;
			workSheet.Cells[rowCnt + 1, colCnt + 23].Style.Fill.BackgroundColor.SetColor(voiletBGColor);

			workSheet.Cells[rowCnt + 2, colCnt + 22].Value = "";
			workSheet.Cells[rowCnt + 2, colCnt + 22].Style.Fill.PatternType = ExcelFillStyle.Solid;
			workSheet.Cells[rowCnt + 2, colCnt + 22].Style.Fill.BackgroundColor.SetColor(blueBGColor);

			workSheet.Cells[rowCnt + 2, colCnt + 23].Value = "";
			workSheet.Cells[rowCnt + 2, colCnt + 23].Style.Fill.PatternType = ExcelFillStyle.Solid;
			workSheet.Cells[rowCnt + 2, colCnt + 23].Style.Fill.BackgroundColor.SetColor(blueBGColor);
		...
		public async Task<IActionResult> ExportCenterReport(string CenterId, string selectedMonth, string selectedYear)
		{
			...
			if (lstVetNames.Count > 0)
			{
				...
				string totalByCenter = "Total Released  (@ " + centerName + ")";
		...
		private void DesignCalenderTableHeader(int days, ExcelWorksheet workSheet, int rowCnt, int colCnt)
		{
			...
			workSheet.Cells[rowCnt, colCnt + 7].Value = "Deaths";
			...
			workSheet.Cells[rowCnt, colCnt + 8].Value = "Total Released";
